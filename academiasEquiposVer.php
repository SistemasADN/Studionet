ogi<?php include 'templates/top.php'; ?>
    ...
    <table class="table table-hover table-responsive" id="equiposVer">
      <thead>
        <tr class="table-header">
          ...
          <th class="table-column-title">MAESTRO</th>
        ...
        <div class="modal-body">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 modal-content-container">
            <fieldset>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 input-container">
                <select class="selectpicker form-input" data-live-search="true" data-script="sedeSelect" required data-label="Sede" id="sedeSearch" name='Sede'> </select>
              </div>
              <div class="col-xs-12 col-sm-12 col-md-12 input-container">
                <select class="selectpicker form-input" data-live-search="true" data-script="profesorSelect" required data-label="Maestro" id="profesorSearch" name='Maestro'> </select>
              </div>
              <div class="col-xs-12 col-sm-12 col-md-12 input-container">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 input-container">
                <button type="button" class="btn btn-save" data-form="form-input" data-function="afterEdit" data-script="editarEquipo" data-clear="true" id="editarEquipo">Guardar</button>
              </div>
            </fieldset>
          </div>
        </div>
  ...
  <?php include 'templates/bottom.php'; ?>
    <script>
      ...
      function afterEdit(data, extra) {
        ...
        data.estatus = data.activo == 1 ? "ACTIVO" : "INACTIVO";
        data.sedeSearch = Number(data.sedeSearch);
        data.idEquipo = Number(data.idEquipo);
        data.idSede = Number(data.sedeSearch);
        data.idProfesor = Number(data.profesorSearch);
        data.profesor = data.nombre + " " + data.apellidoPaterno;
        data.profesor = data.apellidoMaterno == "" ? data.profesor : data.profesor + " " + data.apellidoMaterno;
        data.profesorSearch = Number(data.profesorSearch);
        data.nombreSede = extra.sedeSearch;
        var buttons = [["Editar", "btn-edit", editarEquipo]];
        tableUtilities.updateRow('equiposVer', {
