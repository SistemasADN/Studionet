    ...
    <table class="table table-hover table-responsive" id="equiposVer">
      <thead>
        <tr class="table-header">
          ...
          <th class="table-column-title">NOMBRE DE LA DISCIPLINA</th>
  ...
  <?php include 'templates/bottom.php'; ?>
    <script>
      $(document).ready(function () {
        //Csser.collapse(7);
        tableUtilities.createTable('equiposVer', ['nombreEquipo', 'nombreDisciplina', 'nombreProfesor', 'acciones']);
      ...
      function agregarEquipo(data) {
        console.log(data);
        if(data.nombreDisciplina===null){
          data.nombreDisciplina = 'No se ha asignado un grupo al equipo';
        }
      ...
      function afterBaja(data) {
        //console.log(data);
        tableUtilities.deleteRow('equiposDetallesVer', {
