...
if(settings.format)
{
    ...
    {
        settings.width = (format[settings.format.toLowerCase()][1]*dpi);
        settings.height = (format[settings.format.toLowerCase()][0]*dpi);
    }
    else
    {
        settings.width = (format[settings.format.toLowerCase()][0]*dpi);
        settings.height = (format[settings.format.toLowerCase()][1]*dpi);
    }
}
else
{
...
function processViewSettings()
{
    ...
    viewportSize.width = pageOverPaper*(settings.width - settings.margin.left - settings.margin.right);
...
function run()
{
    ...
    //To make the page access to resources
