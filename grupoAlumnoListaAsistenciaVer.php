<?php include 'templates/top.php'; ?>
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 title-container">
    ...
    <div class="text-container"> ASISTENCIA POR ALUMNO </div>
  </div>
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 form-container">
            <fieldset>
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="text-container-subtitle"> SELECCIONE UN RANGO DE FECHAS Y UN ALUMNO </div>
              </div>
              <div class="col-xs-12 col-sm-12 col-md-12 input-container date-container">
                <label class='label-fecha'>ALUMNO</label>
                <div class="col-xs-12 col-sm-12 col-md-12 input-container">
                  <select class="selectpicker form-input" data-live-search="true" data-label="Alumno" id="idAlumno" > </select>
                </div>
              </div>
  ...
  <?php include 'templates/bottom.php'; ?>
    <script>
      $(document).ready(function () {
        ...
        $("#fechaInicial,#fechaFinal,#idAlumno").change(loadTable);
        loadTable();
      });
      ...
      function loadTable(){
        ...
        if(data.idAlumno!==undefined&&data.idAlumno!==null){
            tableUtilities.loadScript('listaAsistencias', 'getDetallesAsistenciaAlumno', data, loadAsistencia);
