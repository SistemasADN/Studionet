      ...
      <fieldset>
        <div class="col-xs-12 col-sm-12 col-md-12">
          <div class="jumbotron jumbotron-container">
            <div class="jumbotron-text"><abbr title = 'Llene el formulario para agregar un cliente al sistema'>NOMBRE COMPLETO</abbr></div>
          </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 input-container">
          <select class="selectpicker form-input" data-live-search="false" required data-label="Género" data-script="generoSelect" id="generoSearch" name='Género'> </select>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-6 input-container date-container">
          ...
          <div class="input-group date form-input" id="fechaSelect"> <span class="input-group-addon">
            ...
            <input type="text" class="form-control" required id="fechaSelectText"> </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
          <div class="jumbotron jumbotron-container">
            <div class="jumbotron-text"> CREAR ALUMNO COMO CLIENTE </div>
          </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 input-container">
          <div class="col-xs-4 col-sm-1 col-md-1">
            <input type="checkbox" class="form-control form-input" id="checkAlumno">
          </div>
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 input-container marTop-md">
          <input type="text" placeholder="País" id="countrySum" name='pais' disabled/>
          <input type="hidden" id="countryIdSum" name='País' /> </div>
          <div class="col-xs-12 col-sm-12 col-md-12 input-container">
            <button type="button" class="btn btn-save" data-form="form-input" data-script="agregarCliente" data-function="afterEdit" data-clear="true" id="agregarCliente">AGREGAR CLIENTE</button>
          </div>
      </fieldset>
    </div>
  </div>
