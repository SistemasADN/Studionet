  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-container">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 filter-container">
      <div class="col-xs-12 col-sm-12 col-md-12">
        <legend class="custom-legend"><abbr title = 'Al elegir un alumno se desplegarán en su pantalla los espacios en los que dicho alumno se encuentra inscrito.'>Elije un alumno</abbr></legend>
      </div>
  ...
  <?php include 'templates/bottom.php'; ?>
    <script>
      $(document).ready(function () {
        ...
        Utilizer.loadSelect('alumnoSearch', 'alumnoSelect', 'Alumno');
        ...
        function loadHorario(data) {
          ...
          for (i = 0; i < data.length; i++) {
            ...
            actual.letra = actual.nombreGrupo;
