<?php include 'templates/top.php'; ?>
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 title-container">
    ...
    <div class="text-container"> VER HORARIO GRUPO </div>
  </div>
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-container">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 filter-container">
      <div class="col-xs-12 col-sm-12 col-md-12">
        <legend class="custom-legend"><abbr title = 'Al elejir una clase se desplegarán en su pantalla los salones que dicha clase ocupará durante la semana'>Elije un grupo.</abbr></legend>
      </div>
      ...
      <!-- TABLA -->
      <div class="col-xs-12 col-sm-12 col-md-12">
        <legend class="custom-legend">Lista de Salones</legend>
      </div>
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-container">
