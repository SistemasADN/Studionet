...
LEFT JOIN direccion as d
  ...
  LEFT JOIN personal_usuario as pu ON pu.idUsuario = u.idUsuario
    WHERE u.idTipoUsuario <> 5 AND u.idTipoUsuario <> 3 AND pu.idUsuario IS NULL"));
?>
