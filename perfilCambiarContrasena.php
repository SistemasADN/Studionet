  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 content-container">
    <div class="col-xs-12 col-sm-12 col-md-8 form-container">
      <fieldset>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 input-container">
          <button type="button" class="btn btn-save" data-form="form-input" data-script="cambiarContrasena" data-clear="true" id="cambiarContrasena">Cambiar contraseña</button>
        </div>
      </fieldset>
    </div>
  </div>
