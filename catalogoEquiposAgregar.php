      ...
      <fieldset>
        <div class="col-xs-12 col-sm-12 col-md-12">
          <div class="jumbotron jumbotron-container">
            <div class="jumbotron-text"><abbr title = 'Llene los espacios obligatorios para crear un equipo'>DATOS DEL EQUIPO </abbr></div>
          </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 input-container">
          <button type="button" class="btn btn-save" data-form="form-input" data-script="agregarEquipo" data-clear="true" id="agregarEquipo">AGREGAR EQUIPO</button>
        </div>
      </fieldset>
    </div>
  </div>
